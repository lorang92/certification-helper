function onload() {
    ...
    myVideo.addEventListener("mouseover", function(e) {
        myVideo.play();
    ...
    myVideo.addEventListener("mouseleave", function(e) {
        myVideo.pause();
    });


    // TODO 2d: Handle the play/pause events for the video, to regularly copy the video frame into the canvas.
    myVideo.addEventListener("play", function(e) {
        setInterval(updateCanvasFrame, 20);
    });

    myVideo.addEventListener("pause", function(e) {
        clearInterval(updateCanvasFrame);
    })

    var updateCanvasFrame = function() {
        
        //context.drawImage(myVideo, 0, 0, context.width, context.height);
    }
