...
public class Exercise2 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Please enter a year between 0 and 2099 inclusive: ");
		int year = scanner.nextInt();

		// Ask the user to enter a month.
		System.out.print("Please enter a month between 1 and 12 inclusive: ");
		...
		System.out.print("Please enter a day between 1 and " + daysInMonth + " inclusive: ");
